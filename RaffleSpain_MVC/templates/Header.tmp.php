        ...
        <ul>
            ...
            <?php 
                if(!isset($_SESSION['usuari'])) {
                    ...
                    echo '<li><a href="?client/modificarDatos"><svg xmlns="http://www.w3.org/2000/svg" width="16" class="icono" height="16" fill="currentColor" class="bi bi-person-fill-gear" viewBox="0 0 16 16">
